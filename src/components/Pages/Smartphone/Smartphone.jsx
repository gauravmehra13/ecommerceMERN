...
function Phone() {
  ...
  useEffect(() => {
    fetch('https://ecommerce-backend-brm6-egmwpw3i8-gauravmehra13.vercel.app/smart')
  ...
  return (
    <div className="App">
      <h1 style={{backgroundColor:"black",color:"white",fontFamily:"cursive"}}>Smartphone</h1>
