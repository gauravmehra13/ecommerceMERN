...
const BestSellers = () => {
  ...
  // const data = "http://localhost:5900/acc"
    ...
    <div>
      ...
      <nav className="category-filters">
        ...
        >
          ...
          <ToggleButton value="mac">GalaxyBook</ToggleButton>
          <ToggleButton value="iphone">SMARTPHONE</ToggleButton>
          <ToggleButton value="ipad">TABLET</ToggleButton>
          <ToggleButton value="watch">Watch</ToggleButton>
          <ToggleButton value="accessories">Accessories</ToggleButton>
          <ToggleButton value="others">TV</ToggleButton>
        </ToggleButtonGroup>
      </nav>
